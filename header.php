	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">FoodBank</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($cur_page == 'food-group-add.php')||($cur_page == 'food-group.php')||($cur_page == 'food-group-edit.php') ) {echo 'active';} ?>">
			          <a href="food-group.php">
			            <i class="fa fa-hand-o-right"></i> <span>Food Group</span>
			          </a>
			        </li>
